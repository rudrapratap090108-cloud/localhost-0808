...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mighty Mindz International PreSchool" },
      { property: "og:title", content: "Mighty Mindz International PreSchool" },
      { name: "twitter:title", content: "Mighty Mindz International PreSchool" },
