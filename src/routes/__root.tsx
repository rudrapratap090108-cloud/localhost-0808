...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Lumina School Suite is a premium, AI-powered school management platform for websites and mobile apps." },
      { property: "og:description", content: "Lumina School Suite is a premium, AI-powered school management platform for websites and mobile apps." },
      { name: "twitter:description", content: "Lumina School Suite is a premium, AI-powered school management platform for websites and mobile apps." },
